...
- Updated dependencies [571cb48]
  - @sundaeswap/math@0.4.0
...
- bf3ba49: Adopt the audit-final v4 PoolDatum, PoolConfig and order constraint sets — the
...
- 1a449fa: Fix the published `@sundaeswap/math` dependency so Core includes the pool math
  exports it imports.
...
- Updated dependencies [13b0ffd]
  - @sundaeswap/math@0.3.0

## 2.12.0

### Minor Changes

- 1a7263c: Add Sundae v4 support to the SDK: `TxBuilderV4` with `swap`, `basic`
...
- 5fcfe64: Include Contract types as an export.
