...
import { V3Types } from "../DatumBuilders/GeneratedContractTypes/index.js";
...
export class TxBuilderV3Like extends TxBuilderAbstractV3 {
  ...
  constructor(
    ...
    this.datumBuilder = new DatumBuilderV3Like(network);
  }
   ...
   *
   * @param {TMintPoolConfigArgs} args - Configuration arguments for minting the pool, including assets,
  ...
  async mintPool(
    ...
    if (args.donateToTreasury) {
      ...
      if (args.donateToTreasury === 100n) {
        ...
        const donation = (circulatingLp * args.donateToTreasury) / 100n;
