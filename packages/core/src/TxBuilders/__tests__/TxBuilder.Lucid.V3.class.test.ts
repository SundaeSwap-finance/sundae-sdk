...
describe("TxBuilderLucidV3", () => {
  ...
  it("should have the correct parameters", () => {
    ...
    expect(TxBuilderLucidV3.getParam("scriptAddress", "preview")).toEqual(
      "addr_test1wpyyj6wexm6gf3zlzs7ez8upvdh7jfgy3cs9qj8wrljp92su9hpfe"
    );
    expect(TxBuilderLucidV3.getParam("scriptValidator", "preview")).toEqual(
    ...
    // @TODO Add these values when mainnet launched.
    expect(TxBuilderLucidV3.getParam("scriptAddress", "mainnet")).toEqual("");
    expect(TxBuilderLucidV3.getParam("scriptValidator", "mainnet")).toEqual("");
  });
      ...
      (index) => {
        ...
        if (
          getPaymentAddressFromOutput(output) ===
            TxBuilderLucidV3.getParam("scriptAddress", "preview") &&
