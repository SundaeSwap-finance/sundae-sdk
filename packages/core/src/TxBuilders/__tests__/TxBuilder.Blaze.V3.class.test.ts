import { Blaze, Core, Data, makeValue } from "@blaze-cardano/sdk";
...
const getPaymentAddressFromOutput = (output: Core.TransactionOutput) => {
  return output.address().toBech32();
};

const { getUtxosByOutRefMock } = setupBlaze((lucid) => {
