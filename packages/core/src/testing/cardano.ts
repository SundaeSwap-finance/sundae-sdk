...
const MockWalletApi = () => {
  const mockAPI: WalletApi = {
    experimental: {
      async getCollateral() {
        return [walletApiResponses.utxos[0]];
      },
      off(eventName, callback) {},
      on(eventName, callback) {},
    },
    async getBalance() {
      return walletApiResponses.balance;
    },
    async getChangeAddress() {
      return walletApiResponses.changeAddress;
    },
    async getNetworkId() {
      return walletApiResponses.networkId;
    },
    async getRewardAddresses() {
      return walletApiResponses.rewardAddresses;
    },
    async getCollateral() {
      return walletApiResponses.collateral;
    },
    async getUnusedAddresses() {
      return walletApiResponses.unusedAddresses;
    },
    async getUsedAddresses() {
      return walletApiResponses.usedAddresses;
    },
    async getUtxos() {
      return walletApiResponses.utxos;
    },
    async submitTx(tx) {
      return "test-preview-txhash";
    },
...
// const MockedLucid = jest.fn().mockImplementation(() => {
//   return {
//     new: jest.fn(),
//   };
// });

// const MockLucidCardano = () => {
//   beforeEach(() => {
//     mockWindow();
//     MockedLucid.mockClear();
//   });
